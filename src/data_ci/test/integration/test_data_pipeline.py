...
from data_ci.data_pipeline import run
from data_ci.utils.db import WarehouseConnection
from data_ci.utils.sde_config import get_warehouse_creds
...
class TestDataPipeline:
    ...
    def test_data_pipeline(self):
        ...
        expected_data = [(1, "The"), (2, "Khuyen"), (3, "Tri"), (4, "no name")]
